...
export default function ServiceOverviewCard({
  ...
  return (
    <Link href={`${servicePageLinkUrl}`}>
      <div
        className="group h-full service-overview-card bg-white p-6 rounded-lg shadow-md border-2
         border-gray-300 flex flex-col hover:shadow-lg transition-all duration-300"
        id={`${serviceSectionId}`}
      >
        {/* image section */}
        <div className="service-image flex justify-center">
          <div className="relative w-full h-48 md:h-56 lg:h-64 rounded-3xl overflow-hidden shrink-0">
            <Image
              ...
              fill
              className="object-cover rounded-3xl group-hover:scale-110 transition-all duration-300"
