    ...
    return(
        <nav className="w-full bg-background px-4 py-2 flex justify-between items-center">
            ...
            <div className="md:hidden mobile-nav-links">
                {!mobileMenuOpen && (
                    <RiMenuLine size={30} className="cursor-pointer" color="white" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} />
                )}
                {mobileMenuOpen && (
                    <RiCloseLine size={30} className="cursor-pointer" color="white" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} />
                )}
